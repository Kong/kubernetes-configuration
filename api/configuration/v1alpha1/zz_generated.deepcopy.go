...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericEntityRef) DeepCopyInto(out *GenericEntityRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericEntityRef.
func (in *GenericEntityRef) DeepCopy() *GenericEntityRef {
	if in == nil {
		return nil
	}
	out := new(GenericEntityRef)
	in.DeepCopyInto(out)
	return out
}
