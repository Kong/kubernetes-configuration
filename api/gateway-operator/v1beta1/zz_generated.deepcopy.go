...
func (in *GatewayConfigServiceOptions) DeepCopyInto(out *GatewayConfigServiceOptions) {
	*out = *in
	...
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]GatewayConfigurationServicePort, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GatewayConfigurationServicePort) DeepCopyInto(out *GatewayConfigurationServicePort) {
	*out = *in
	out.TargetPort = in.TargetPort
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GatewayConfigurationServicePort.
func (in *GatewayConfigurationServicePort) DeepCopy() *GatewayConfigurationServicePort {
	if in == nil {
		return nil
	}
	out := new(GatewayConfigurationServicePort)
	in.DeepCopyInto(out)
	return out
}
