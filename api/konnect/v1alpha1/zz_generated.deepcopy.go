...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSVPCPeeringGateway) DeepCopyInto(out *AWSVPCPeeringGateway) {
	*out = *in
	out.AttachmentConfig = in.AttachmentConfig
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSVPCPeeringGateway.
func (in *AWSVPCPeeringGateway) DeepCopy() *AWSVPCPeeringGateway {
	if in == nil {
		return nil
	}
	out := new(AWSVPCPeeringGateway)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AwsVpcPeeringGatewayAttachmentConfig) DeepCopyInto(out *AwsVpcPeeringGatewayAttachmentConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AwsVpcPeeringGatewayAttachmentConfig.
func (in *AwsVpcPeeringGatewayAttachmentConfig) DeepCopy() *AwsVpcPeeringGatewayAttachmentConfig {
	if in == nil {
		return nil
	}
	out := new(AwsVpcPeeringGatewayAttachmentConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KonnectTransitGatewayAPISpec) DeepCopyInto(out *KonnectTransitGatewayAPISpec) {
	*out = *in
	...
	if in.AWSVPCPeeringGateway != nil {
		in, out := &in.AWSVPCPeeringGateway, &out.AWSVPCPeeringGateway
		*out = new(AWSVPCPeeringGateway)
		**out = **in
	}
