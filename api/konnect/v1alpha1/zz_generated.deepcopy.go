...
func (in *ConfigurationDataPlaneGroupAutoscale) DeepCopyInto(out *ConfigurationDataPlaneGroupAutoscale) {
	*out = *in
	if in.ConfigurationDataPlaneGroupAutoscaleStatic != nil {
		in, out := &in.ConfigurationDataPlaneGroupAutoscaleStatic, &out.ConfigurationDataPlaneGroupAutoscaleStatic
		*out = new(ConfigurationDataPlaneGroupAutoscaleStatic)
		**out = **in
	}
	if in.ConfigurationDataPlaneGroupAutoscaleAutopilot != nil {
		in, out := &in.ConfigurationDataPlaneGroupAutoscaleAutopilot, &out.ConfigurationDataPlaneGroupAutoscaleAutopilot
...
func (in *KonnectCloudGatewayDataPlaneGroupConfigurationStatusGroup) DeepCopyInto(out *KonnectCloudGatewayDataPlaneGroupConfigurationStatusGroup) {
	*out = *in
	...
	if in.CloudGatewayNetworkID != nil {
		in, out := &in.CloudGatewayNetworkID, &out.CloudGatewayNetworkID
		*out = new(string)
		**out = **in
	}
