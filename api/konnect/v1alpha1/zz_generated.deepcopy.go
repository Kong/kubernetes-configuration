...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KonnectCloudGatewayNetworkAPISpec) DeepCopyInto(out *KonnectCloudGatewayNetworkAPISpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KonnectCloudGatewayNetworkAPISpec.
func (in *KonnectCloudGatewayNetworkAPISpec) DeepCopy() *KonnectCloudGatewayNetworkAPISpec {
	if in == nil {
		return nil
	}
	out := new(KonnectCloudGatewayNetworkAPISpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KonnectCloudGatewayNetworkSpec) DeepCopyInto(out *KonnectCloudGatewayNetworkSpec) {
	*out = *in
	in.KonnectCloudGatewayNetworkAPISpec.DeepCopyInto(&out.KonnectCloudGatewayNetworkAPISpec)
