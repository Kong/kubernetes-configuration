...
func (c *kongPluginBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KongPluginBinding, err error) {
	result = &v1alpha1.KongPluginBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *kongPluginBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KongPluginBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.KongPluginBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kongpluginbindings").
...
func (c *kongPluginBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kongPluginBindings) Create(ctx context.Context, kongPluginBinding *v1alpha1.KongPluginBinding, opts v1.CreateOptions) (result *v1alpha1.KongPluginBinding, err error) {
	result = &v1alpha1.KongPluginBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kongpluginbindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kongPluginBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *kongPluginBindings) Update(ctx context.Context, kongPluginBinding *v1alpha1.KongPluginBinding, opts v1.UpdateOptions) (result *v1alpha1.KongPluginBinding, err error) {
	result = &v1alpha1.KongPluginBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kongpluginbindings").
		Name(kongPluginBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(kongPluginBinding).
		Do(ctx).
		Into(result)
...
func (c *kongPluginBindings) UpdateStatus(ctx context.Context, kongPluginBinding *v1alpha1.KongPluginBinding, opts v1.UpdateOptions) (result *v1alpha1.KongPluginBinding, err error) {
	result = &v1alpha1.KongPluginBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kongpluginbindings").
...
func (c *kongPluginBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kongPluginBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kongPluginBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KongPluginBinding, err error) {
	result = &v1alpha1.KongPluginBinding{}
