...
func (c *kongRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.KongRoute, err error) {
...
func (c *kongRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.KongRouteList, err error) {
...
func (c *kongRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *kongRoutes) Create(ctx context.Context, kongRoute *v1alpha1.KongRoute, opts v1.CreateOptions) (result *v1alpha1.KongRoute, err error) {
	result = &v1alpha1.KongRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("kongroutes").
...
func (c *kongRoutes) Update(ctx context.Context, kongRoute *v1alpha1.KongRoute, opts v1.UpdateOptions) (result *v1alpha1.KongRoute, err error) {
	result = &v1alpha1.KongRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kongroutes").
...
func (c *kongRoutes) UpdateStatus(ctx context.Context, kongRoute *v1alpha1.KongRoute, opts v1.UpdateOptions) (result *v1alpha1.KongRoute, err error) {
	result = &v1alpha1.KongRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("kongroutes").
...
func (c *kongRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *kongRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *kongRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.KongRoute, err error) {
	result = &v1alpha1.KongRoute{}
