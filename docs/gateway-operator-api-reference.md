...
## Packages
- [gatewayoperator.konghq.com/v1alpha1](#gatewayoperatorkonghqcomv1alpha1)
- [gatewayoperator.konghq.com/v1beta1](#gatewayoperatorkonghqcomv1beta1)


## gatewayoperator.konghq.com/v1alpha1
...
| Field | Description |
| --- | --- |
| `apiVersion` _string_ | `gatewayoperator.konghq.com/v1alpha1`
...
## gatewayoperator.konghq.com/v1beta1

Package v1alpha1 contains API Schema definitions for the gateway-operator.konghq.com v1beta1 API group.
...
| Field | Description |
| --- | --- |
| `apiVersion` _string_ | `gatewayoperator.konghq.com/v1beta1`
