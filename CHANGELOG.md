...
> Release DateL 2025-08-25

[v1.5.3]: https://github.com/Kong/kubernetes-configuration/compare/v1.5.2...v1.5.3
...
- fix `KongUpstreamPolicy` CRD CEL validation rules on hash_on
  [#499](https://github.com/Kong/kubernetes-configuration/pull/499)
